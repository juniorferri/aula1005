...
public class Produto {
    ...
    @Id
    @SequenceGenerator(name = "seqProduto", sequenceName = "tb_produto_id_seq", allocationSize = 1)
    ...
    private Double dblQuantidadeEstoque;

    @Column(name = "nu_preco_unidade_atual")
    private BigDecimal nuPrecoUnidadeAtual ;
